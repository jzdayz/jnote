...
public class CsChatSessionServiceIndexTempDTO {
    private Long id;
    ...
    private Double avgRespTimeFirstCount;

    private Double sessionDurationTimeCount;

    private Double sessionBoutTimeCount;

    private Double sessionBoutCount;
    ...
    public Double getAvgRespTimeFirstCount() {
        return avgRespTimeFirstCount;
    }

    public void setAvgRespTimeFirstCount(Double avgRespTimeFirstCount) {
        this.avgRespTimeFirstCount = avgRespTimeFirstCount;
    }
    ...
    public Double getSessionBoutTimeCount() {
        return sessionBoutTimeCount;
    }

    public void setSessionBoutTimeCount(Double sessionBoutTimeCount) {
        this.sessionBoutTimeCount = sessionBoutTimeCount;
    }

    public Double getSessionBoutCount() {
        return sessionBoutCount;
    }

    public void setSessionBoutCount(Double sessionBoutCount) {
        this.sessionBoutCount = sessionBoutCount;
    }
}