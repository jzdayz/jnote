...
public class ShopTeamHourIndexDTO2 {
    private Long id;
    ...
    public Date getTimeDot() {
        return timeDot;
    }

    public void setTimeDot(Date timeDot) {
        this.timeDot = timeDot;
    }

    public Double getOrderAmountToday() {
        return orderAmountToday;
    }

    public void setOrderAmountToday(Double orderAmountToday) {
        this.orderAmountToday = orderAmountToday;
    }
    ...
    public Integer getEnquiryBuyerNum() {
        return enquiryBuyerNum;
    }

    public void setEnquiryBuyerNum(Integer enquiryBuyerNum) {
        this.enquiryBuyerNum = enquiryBuyerNum;
    }
}